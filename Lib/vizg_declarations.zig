...
pub const VIZG_HIR_REACH_TRIGGER_PROMISE_BASE: u32 = c.VIZG_HIR_REACH_TRIGGER_PROMISE_BASE;
...
test "public header versions match the declaration companion" {
    ...
    try std.testing.expectEqual(@as(u32, 10), VIZG_HIR_DETAIL_API_VERSION);
    ...
    try std.testing.expectEqual(@as(u32, 1 << 9), VIZG_HIR_REACH_TRIGGER_PROMISE_BASE);
