...
pub const VIZG_HIR_CONSUMER_API_VERSION = abi.VIZG_HIR_CONSUMER_API_VERSION;
...
pub const VIZG_LANGUAGE_ITEM_NAMESPACE_VALUE = abi.VIZG_LANGUAGE_ITEM_NAMESPACE_VALUE;
pub const VIZG_LANGUAGE_ITEM_NAMESPACE_TYPE = abi.VIZG_LANGUAGE_ITEM_NAMESPACE_TYPE;
...
pub const VIZG_EXTERNAL_TYPE_REFERENCE_BUILTIN = abi.VIZG_EXTERNAL_TYPE_REFERENCE_BUILTIN;
pub const VIZG_EXTERNAL_TYPE_REFERENCE_DECLARED = abi.VIZG_EXTERNAL_TYPE_REFERENCE_DECLARED;
pub const Vizg_ExternalTypeReferenceV3 = abi.Vizg_ExternalTypeReferenceV3;
pub const Vizg_ExternalTypeMemberV3 = abi.Vizg_ExternalTypeMemberV3;
pub const Vizg_ExternalTypeV3 = abi.Vizg_ExternalTypeV3;
pub const Vizg_ExternalParameterV3 = abi.Vizg_ExternalParameterV3;
pub const Vizg_ExternalFunctionV3 = abi.Vizg_ExternalFunctionV3;
pub const Vizg_ExternalExportV3 = abi.Vizg_ExternalExportV3;
pub const Vizg_ExternalModuleV3 = abi.Vizg_ExternalModuleV3;
pub const Vizg_ExternalExportV4 = abi.Vizg_ExternalExportV4;
pub const Vizg_ExternalModuleV4 = abi.Vizg_ExternalModuleV4;
...
pub const Vizg_SourceLanguageItem = abi.Vizg_SourceLanguageItem;
...
pub const Vizg_HirConsumerKind = abi.Vizg_HirConsumerKind;
pub const Vizg_HirConsumerInfo = abi.Vizg_HirConsumerInfo;
...
pub const VIZG_HIR_REACH_TRIGGER_PRIMITIVE_NUMBER_BASE = abi.VIZG_HIR_REACH_TRIGGER_PRIMITIVE_NUMBER_BASE;
pub const VIZG_HIR_REACH_TRIGGER_PRIMITIVE_BOOLEAN_BASE = abi.VIZG_HIR_REACH_TRIGGER_PRIMITIVE_BOOLEAN_BASE;
pub const VIZG_HIR_REACH_TRIGGER_PRIMITIVE_BIGINT_BASE = abi.VIZG_HIR_REACH_TRIGGER_PRIMITIVE_BIGINT_BASE;
...
pub const VIZG_HIR_REACH_TRIGGER_PROMISE_BASE = abi.VIZG_HIR_REACH_TRIGGER_PROMISE_BASE;
...
pub const Vizg_HirClassDetail = abi.Vizg_HirClassDetail;
pub const Vizg_HirClassMethod = abi.Vizg_HirClassMethod;
...
pub const Vizg_HirLanguageItem = abi.Vizg_HirLanguageItem;
