...
enum {
    ...
    VIZG_HIR_OPERATION_APPLY_PATTERN = 61,
    VIZG_HIR_OPERATION_INTRINSIC_CALL = 62,
    VIZG_HIR_OPERATION_ARRAY_INITIALIZE = 63,
};

typedef uint32_t Vizg_HirPatternPosition;
enum {
    VIZG_HIR_PATTERN_POSITION_DECLARATION = 0,
    VIZG_HIR_PATTERN_POSITION_ASSIGNMENT = 1,
    VIZG_HIR_PATTERN_POSITION_PARAMETER = 2,
    VIZG_HIR_PATTERN_POSITION_CATCH_BINDING = 3,
};

typedef uint32_t Vizg_HirPatternItemTag;
enum {
    VIZG_HIR_PATTERN_ITEM_ARRAY_BEGIN = 0,
    VIZG_HIR_PATTERN_ITEM_ARRAY_END = 1,
    VIZG_HIR_PATTERN_ITEM_OBJECT_BEGIN = 2,
    VIZG_HIR_PATTERN_ITEM_OBJECT_END = 3,
    VIZG_HIR_PATTERN_ITEM_ELISION = 4,
    VIZG_HIR_PATTERN_ITEM_ELEMENT = 5,
    VIZG_HIR_PATTERN_ITEM_PROPERTY_STATIC = 6,
    VIZG_HIR_PATTERN_ITEM_PROPERTY_COMPUTED = 7,
    VIZG_HIR_PATTERN_ITEM_REST = 8,
    VIZG_HIR_PATTERN_ITEM_DEFAULT_VALUE = 9,
    VIZG_HIR_PATTERN_ITEM_BINDING_TARGET = 10,
    VIZG_HIR_PATTERN_ITEM_PLACE_TARGET = 11,
};
...
#define VIZG_HIR_REACH_TRIGGER_PRIMITIVE_NUMBER_BASE (1u << 4)
#define VIZG_HIR_REACH_TRIGGER_PRIMITIVE_BOOLEAN_BASE (1u << 5)
#define VIZG_HIR_REACH_TRIGGER_PRIMITIVE_BIGINT_BASE (1u << 6)
#define VIZG_HIR_REACH_TRIGGER_PRIMITIVE_SYMBOL_BASE (1u << 7)
#define VIZG_HIR_REACH_TRIGGER_FUNCTION_BASE (1u << 8)
#define VIZG_HIR_REACH_TRIGGER_PROMISE_BASE (1u << 9)
#define VIZG_HIR_REACH_TRIGGER_STRING_CONCAT_ADD (1u << 3)
