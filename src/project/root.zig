...
pub const LanguageItemId = contracts.LanguageItemId;
pub const LanguageItemNamespace = contracts.LanguageItemNamespace;
pub const SourceLanguageItem = contracts.SourceLanguageItem;
pub const language_item_contract_version = contracts.language_item_contract_version;
...
pub const ExternalTypeReference = contracts.ExternalTypeReference;
...
pub const ExternalTypeMemberDescriptor = contracts.ExternalTypeMemberDescriptor;
pub const ExternalTypeDescriptor = contracts.ExternalTypeDescriptor;
