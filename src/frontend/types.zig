...
const builtin_kind = @import("../builtins.builtin_kind.zig");
...
pub const Type = struct {
    ...
    test "Type.matchesPrimitive compares by kind" {
        const t_num = Type{ .id = 1, .kind = .{ .primitive = .number } };
        const t_str = Type{ .id = 2, .kind = .{ .primitive = .string } };
