...
pub const LanguageItemId = project.LanguageItemId;
pub const LanguageItemNamespace = project.LanguageItemNamespace;
pub const SourceLanguageItem = project.SourceLanguageItem;
pub const language_item_contract_version = project.language_item_contract_version;
...
pub const ExternalTypeReference = project.ExternalTypeReference;
...
pub const ExternalTypeMemberDescriptor = project.ExternalTypeMemberDescriptor;
pub const ExternalTypeDescriptor = project.ExternalTypeDescriptor;
pub const ExternalModuleDescriptor = project.ExternalModuleDescriptor;
pub const AmbientGlobal = project.AmbientGlobal;
pub const AmbientMember = project.AmbientMember;
pub const SourceHostBinding = project.SourceHostBinding;
