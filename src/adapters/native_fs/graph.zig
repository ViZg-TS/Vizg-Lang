...
const externals_mod = core.modules.externals;

const binder = core.binder;
const linker = core.modules.linker;
const graph_types = core.modules.graph;

pub const ModuleId = graph_types.ModuleId;
pub const ImportEdgeId = graph_types.ImportEdgeId;
pub const ImportStatus = graph_types.ImportStatus;
pub const Module = graph_types.Module;
pub const ImportEdge = graph_types.ImportEdge;
pub const ModuleGraph = graph_types.ModuleGraph;
